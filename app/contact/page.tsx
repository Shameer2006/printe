            ...
            <div className="w-full max-w-[600px] space-y-8">
                ...
                <div className="bg-gray-50 rounded-2xl p-8 space-y-8 border border-gray-100">
                    <p className="text-gray-600 leading-relaxed">
                        We are here to help! If you have any questions, concerns, or feedback regarding your A4 sheet dispensing, print orders or our services, please reach out to us. This platform's payment is secured by Zoho Pay.
                    </p>
