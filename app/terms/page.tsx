        ...
        <main className="min-h-screen bg-transparent text-black py-8 px-4 flex justify-center">
            <div className="w-full max-w-[800px] space-y-8">
                ...
                <div className="bg-gray-50 rounded-2xl p-8 space-y-6 border border-gray-100 text-sm text-gray-700 leading-relaxed text-left">
                    ...
                    <p>
                        The Platform is owned by <strong>Printeg Operations</strong> (Contact: 9944563016) with its registered office at <strong>Chennai</strong>, a company incorporated under the Companies Act, 1956 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
                    </p>
                    <p>
